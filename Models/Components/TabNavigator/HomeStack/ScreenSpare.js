...
export default class ScreenSpare extends Component {
    constructor(props) {
        super(props);
        this.state = {
            scrollX: new Animated.Value(0),
            Images: [
                ...[{ name: this.props.route.params.spare.photo}], ...this.props.route.params.spare.photos
            ]
        };
    }

    spareObject= this.props.route.params.spare
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1, paddingBottom: 80, alignItems: 'center' }} >
                        ...
                        <View style={{
                            ...
                            <View style={[styles.rowReversed, { width: '100%' }]} >
                                <Text style={{ fontSize: 28, fontWeight: 'bold', color: '#003f43', textAlign: 'right' }}>{this.spareObject.title}</Text>
                            </View>
                            <View style={[styles.rowReversed, { width: '100%', marginTop: 2 }]} >
                                <FontAwesome5 name="car" style={{ fontSize: 18, color: '#003f43' }} />
                                <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#A8A8A8', textAlign: 'right', marginHorizontal: 6 }}>{this.spareObject.car_name}</Text>
                                <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#A8A8A8', textAlign: 'right' }}>{"-"}</Text>
                                <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#A8A8A8', textAlign: 'right', marginHorizontal: 6 }}>{this.spareObject.car_model_name}</Text>
                                {/* <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#A8A8A8', textAlign: 'right' }}>{"-"}</Text> */}
                            ...
                            <View style={[styles.rowReversed, { width: '100%', marginTop: 2 }]} >
                                ...
                                <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#A8A8A8', textAlign: 'right', marginHorizontal: 6 }}>{this.spareObject.price}</Text>
                            ...
                            <View style={[styles.rowReversed, { width: '100%', marginTop: 2 }]} >
                                ...
                                <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#A8A8A8', textAlign: 'right', marginHorizontal: 6 }}>{this.spareObject.address}</Text>
                            </View>
                            ...
                            <View style={[styles.rowReversed, { width: '100%', marginTop: 8 }]} >
                                <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#A8A8A8', textAlign: 'right' }}>{this.spareObject.description}</Text>
                            </View>
                            <View style={[styles.rowReversed, { width: '100%', marginTop: 12 }]} >
                            ...
                            <View style={[styles.flex, styles.rowReversed, { paddingVertical: 10, borderBottomColor: '#F8F8F8', borderBottomWidth: 1, marginTop: 8 }]}>
                                <View style={[styles.flex]}>
                                    <Image
                                        ...
                                        source={{ uri: this.spareObject.user_photo }}
                                    />
                                </View>
                                <View style={[styles.column, { flex: 1, alignItems: 'flex-end' }]}>
                                    <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#000' }} >{this.spareObject.user_name}</Text>
                                    <Text style={{ color: '#A8A8A8', fontWeight: 'bold' }}>{this.spareObject.user_phonenumber}</Text>
                                </View>
                            </View>
                        </View>
